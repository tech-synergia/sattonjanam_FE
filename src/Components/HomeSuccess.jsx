    ...
    <div className="homeSuccess">
      ...
      <div className="successCards">
        ...
        {/* <Card
          ...
          cover={
            <Link to="/successStories">
              <img alt="example" src={Success2} className="image-size" />
            </Link>
          }
        >
        ...
        <Card
          ...
          cover={
            <Link to="/successStories">
              <img alt="example" src={Success3} className="image-size" />
            </Link>
          }
        >
        ...
        <Card
          ...
          cover={
            <Link to="/successStories">
              <img alt="example" src={Success4} className="image-size" />
            </Link>
          }
        >
      ...
      <Button className="buttonSuccess">
        <NavLink to={"/successStories"}>View All Success Stories</NavLink>
      </Button>
    </div>
  );
}
