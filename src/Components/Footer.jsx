    ...
    <footer>
      <div className="footerColumns">
        <div className="footerLogoInfo">
          ...
          <p>
            Marriage is a journey of two individuals who come together to grow,
            learn, and support each other in every aspect of life.
          </p>
        </div>
        <div className="impLinks">
          ...
          <div>
            <h4>ADDRESS</h4>
            <p style={{ width: "300px" }}>
              65, spring field colony market, sector-32, Faridabad, Near NHPC
              metro station, Haryana, 121003
            </p>
          </div>
        </div>
      ...
      <div className="impLinks">
        <div className="Links logos">
          <span>
            <Link
              to={"whatsapp://send?text=Hi!&phone=9773643677"}
          ...
          <span>
            <Link
              to={"mailto:info@sattonjanam.com"}
          ...
          <span>
            <Link
              to={
                "https://www.linkedin.com/company/sattonjanam-matrimonial-services/about/?viewAsMember=true"
              }
          ...
          <span>
            <Link
              to={
                "https://www.facebook.com/profile.php?id=61550954489680&sk=about_contact_and_basic_info"
              }
          ...
          <span>
            <Link
              to={"https://www.instagram.com/sattonjanam_matrimony/"}
